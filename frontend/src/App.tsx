    ...
    return {
      filters: {
        ...
        status: typeof filters.status === "string" ? filters.status : defaults.filters.status,
          outreachTier: typeof filters.outreachTier === "string" ? filters.outreachTier : defaults.filters.outreachTier,
  ...
  async function refreshStations(): Promise<void> {
    ...
    try {
      const response = await listStations({
        ...
        outreach_tier: (filters as any).outreachTier,
          ...
          <section className="radio-db-workbench">
            <article className="radio-db-panel radio-db-panel--wide">
              ...
              >
                ...
                <label>
                  Tier
                  <select value={(filters as any).outreachTier || ""} onChange={(event) => setFilters((current) => ({ ...current, outreachTier: event.target.value, page: 1 }))}>
